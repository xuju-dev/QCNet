...
# scenario_id = '001-182cf83278a4316c-1'
scenario_id = '003-182cf985f3eea9d1-12'
...
ax.legend()
viz_output_dir = Path("/dev_ws/src/tam_deep_prediction/models/QCNet/QCNet/visualizations/debug")  # path where the figure gets saved to
